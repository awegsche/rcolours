...
pub const XKCD_DARKGREEN: Color = Color(5, 73, 7);
 /// Color `XKCD_GREEN_SLASH_YELLOW` from the set CSS4_COLORS. (Color number `227`)
...
pub const XKCD_FOAM_GREEN: Color = Color(144, 253, 169);
 /// Color `XKCD_GREY_SLASH_GREEN` from the set CSS4_COLORS. (Color number `283`)
...
pub const XKCD_SUNFLOWER_YELLOW: Color = Color(255, 218, 3);
 /// Color `XKCD_GREEN_SLASH_BLUE` from the set CSS4_COLORS. (Color number `296`)
...
pub const XKCD_DARK_SAND: Color = Color(168, 143, 89);
 /// Color `XKCD_PURPLE_SLASH_BLUE` from the set CSS4_COLORS. (Color number `384`)
...
pub const XKCD_DUSTY_RED: Color = Color(185, 72, 78);
 /// Color `XKCD_GREY_SLASH_BLUE` from the set CSS4_COLORS. (Color number `420`)
...
pub const XKCD_LEMON_LIME: Color = Color(191, 254, 40);
 /// Color `XKCD_PURPLE_SLASH_PINK` from the set CSS4_COLORS. (Color number `422`)
...
pub const XKCD_PALE: Color = Color(255, 249, 208);
 /// Color `XKCD_BLUE_SLASH_GREY` from the set CSS4_COLORS. (Color number `437`)
...
pub const XKCD_HELIOTROPE: Color = Color(217, 79, 245);
 /// Color `XKCD_YELLOW_SLASH_GREEN` from the set CSS4_COLORS. (Color number `500`)
...
pub const XKCD_AMETHYST: Color = Color(155, 95, 192);
 /// Color `XKCD_BLUE_SLASH_GREEN` from the set CSS4_COLORS. (Color number `548`)
...
pub const XKCD_GUNMETAL: Color = Color(83, 98, 103);
 /// Color `XKCD_BLUE_SLASH_PURPLE` from the set CSS4_COLORS. (Color number `590`)
...
pub const XKCD_IRISH_GREEN: Color = Color(1, 149, 41);
 /// Color `XKCD_PINK_SLASH_PURPLE` from the set CSS4_COLORS. (Color number `617`)
